<?php
    ...
    function emailExists($conn, $email)
    {
        ...
        {
            header("location: ../Database/konkurss/Sisselogimisvorm/signup.php?error=stmtfailed");
            exit();
        }
    ...
    function createUser($conn, $name, $email, $username, $pwd)
    {
        ...
        if ( !mysqli_stmt_prepare($stmt, $sql) )
        {
            header("location: ../Database/konkurss/konkurss/Sisselogimisvorm/signup.php?error=stmtfailed");
            exit();
        }
    ...
    function loginUser($conn, $username, $pwd)
    {
        ...
        {
            header("location: ../Database/konkurss/konkurss/Sisselogimisvorm/login.php?error=wronglogin");
            exit();
        }
        ...
        else if ($checkPassword === true )
        {
            ...
            header("location: ../Database/konkurss/konkurss/Sisselogimisvorm/konkursAdminLeht.php");
            exit();
        }
    }